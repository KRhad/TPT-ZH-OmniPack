...
class AtmosphereBenchRunnerContractTests(unittest.TestCase):
    ...
    def test_runner_records_its_explicit_git_provenance(self) -> None:
        ...
        self.assertIn("Where-Object", RUNNER)
        self.assertIn("msys\\d*", RUNNER)
        self.assertIn("$gitCommandInfo = $gitCommands[0]", RUNNER)
    ...
    def test_runner_has_an_explicit_rusanov_probe_mode(self) -> None:
        ...
        self.assertIn("[switch] $RunLowMachProjection2D", RUNNER)
        self.assertIn("--run-low-mach-projection-2d", RUNNER)
        self.assertIn("LowMachProjection2D.cpp", RUNNER)
        self.assertIn("atmospherebench_low_mach_projection_2d_probe", RUNNER)
        ...
        self.assertIn("LowMachProjection2DPerformance.cpp", RUNNER)
        self.assertIn("[switch] $RunLowMachProjection2DPerformance", RUNNER)
        self.assertIn("--run-low-mach-projection-2d-performance", RUNNER)
        self.assertIn("geometric_multigrid_reference_grid_within_budget", RUNNER)
