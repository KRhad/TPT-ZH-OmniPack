...
struct HybridPolicyProbeSummary
{
	...
	HybridTransportProbeSummary alternateEosVeryLowMach;
	...
	std::size_t lowMachFixtureCount = 0;
	std::size_t compressibleFixtureCount = 0;
	bool constantPressureTransportPassed = false;
	bool soundSpeedIndependencePassed = false;
	bool crossRouteBoundaryCouplingImplemented = false;
	bool eventLocalSubcyclingImplemented = false;
	bool routerImplemented = false;
