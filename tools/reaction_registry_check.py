...
REQUIRED_REACTIONS = {
    ...
    "nuclear.isotope_decay",
    "nuclear.hydrogen2_capture",
    "nuclear.hydrogen_isotope_ignition",
    "nuclear.cobalt60_activation",
    "nuclear.thorium232_breeding",
    "nuclear.uranium238_breeding",
    "nuclear.uranium235_fission",
    ...
    "chemistry.chlorine_copper_chloride",
    "chemistry.phosphoric_calcium_phosphate",
    "chemistry.hydrochloric_ammonium_chloride",
    "chemistry.sulfide_acid_release",
    "chemistry.calcium_phosphate_fertilizer",
    "chemistry.calcium_carbide_hydrolysis",
    "chemistry.metal_hydride_hydrolysis",
    "chemistry.metal_chloride_hydrolysis",
    "chemistry.copper_chloride_displacement",
    "chemistry.ammonium_chloride_decomposition",
    "chemistry.sulfur_trioxide_oxidation",
    "chemistry.sulfur_trioxide_hydration",
    "chemistry.nitric_oxide_oxidation",
    "chemistry.hydrogen_cyanide_cleanup",
    "chemistry.silicon_carbide_oxidation",
    "chemistry.nitric_oxide_synthesis",
    "chemistry.iron_sulfide_synthesis",
    "chemistry.sodium_sulfide_synthesis",
    "chemistry.calcium_carbide_synthesis",
    "chemistry.silicon_carbide_synthesis",
    "chemistry.boron_nitride_synthesis",
    "chemistry.silicon_nitride_synthesis",
    "chemistry.sodium_hydride_synthesis",
    "chemistry.calcium_hydride_synthesis",
}
