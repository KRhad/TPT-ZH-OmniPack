...
local ids = {
    he = must_element("OMNI_PT_HE", "HELI", 370),
    ne = must_element("OMNI_PT_NE", "NEON", 375),
    ar = must_element("OMNI_PT_AR", "ARGN", 379),
    kr = must_element("OMNI_PT_KR", "KRYP", 390),
    xe = must_element("OMNI_PT_XE", "XENO", 405),
    rn = must_element("OMNI_PT_RN", "RADO", 431),
    og = must_element("OMNI_PT_OG", "OGAN", 461),
    sodium = must_element("OMNI_PT_NA", "SODM", 376),
    potassium = must_element("OMNI_PT_K", "POTA", 380),
    caesium = must_element("OMNI_PT_CS", "CAES", 406),
    francium = must_element("OMNI_PT_FR", "FRAN", 432),
    beryllium = must_element("OMNI_PT_BE", "BERY", 371),
    calcium = must_element("OMNI_PT_CA", "CALC", 381),
    strontium = must_element("OMNI_PT_SR", "STRN", 391),
    barium = must_element("OMNI_PT_BA", "BARI", 407),
    radium = must_element("OMNI_PT_RA", "RADI", 433),
    magnesium = must_element("OMNI_PT_MAGN", "MAGN", 261),
    boron = must_element("OMNI_PT_B", "BORO", 372),
    aluminium = must_element("OMNI_PT_ALUM", "ALUM", 256),
    gallium = must_element("OMNI_PT_GA", "GALL", 385),
    indium = must_element("OMNI_PT_IN", "INDI", 401),
    thallium = must_element("OMNI_PT_TL", "THAL", 428),
    nihonium = must_element("OMNI_PT_NH", "NIHO", 456),
    diamond = must_element("DEFAULT_PT_DMND", "DMND", 28),
    silicon = must_element("DEFAULT_PT_SLCN", "SLCN", 187),
    germanium = must_element("OMNI_PT_GE", "GERM", 386),
    tin = must_element("OMNI_PT_TIN", "TINN", 259),
    lead = must_element("OMNI_PT_LEAD", "LEAD", 258),
    flerovium = must_element("OMNI_PT_FL", "FLER", 457),
    nitrogen = must_element("OMNI_PT_N", "NTRG", 373),
    phosphorus = must_element("OMNI_PT_P", "PHOS", 377),
    arsenic = must_element("OMNI_PT_AS", "ARSN", 387),
    antimony = must_element("OMNI_PT_SB", "ANTM", 402),
    bismuth = must_element("OMNI_PT_BI", "BISM", 429),
    moscovium = must_element("OMNI_PT_MC", "MOSC", 458),
    sulfur = must_element("OMNI_PT_S", "SULF", 378),
    selenium = must_element("OMNI_PT_SE", "SELN", 388),
    tellurium = must_element("OMNI_PT_TE", "TELL", 403),
    livermorium = must_element("OMNI_PT_LV", "LIVE", 459),
    fluorine = must_element("OMNI_PT_F", "FLUO", 374),
    chlorine = must_element("OMNI_PT_CHLR", "CHLR", 360),
    bromine = must_element("OMNI_PT_BR", "BROM", 389),
    iodine = must_element("OMNI_PT_I", "IODI", 404),
    astatine = must_element("OMNI_PT_AT", "ASTA", 430),
    tennessine = must_element("OMNI_PT_TS", "TENN", 460),
    scandium = must_element("OMNI_PT_SC", "SCAN", 382),
    titanium = must_element("DEFAULT_PT_TTAN", "TTAN", 144),
    vanadium = must_element("OMNI_PT_V", "VANA", 383),
    chromium = must_element("OMNI_PT_CHRM", "CHRM", 262),
    manganese = must_element("OMNI_PT_MN", "MANG", 384),
    ...
    yttrium = must_element("OMNI_PT_Y", "YTTR", 392),
    zirconium = must_element("OMNI_PT_ZR", "ZIRC", 393),
    niobium = must_element("OMNI_PT_NB", "NIOB", 394),
    molybdenum = must_element("OMNI_PT_MOLY", "MOLY", 264),
    technetium = must_element("OMNI_PT_TC", "TECH", 395),
    ruthenium = must_element("OMNI_PT_RU", "RUTH", 396),
    rhodium = must_element("OMNI_PT_RH", "RHOD", 397),
    palladium = must_element("OMNI_PT_PD", "PALL", 398),
    silver = must_element("OMNI_PT_AG", "SILV", 399),
    cadmium = must_element("OMNI_PT_CD", "CADM", 400),
    lanthanum = must_element("OMNI_PT_LA", "LANT", 408),
    cerium = must_element("OMNI_PT_CE", "CERI", 409),
    praseodymium = must_element("OMNI_PT_PR", "PRAE", 410),
    neodymium = must_element("OMNI_PT_ND", "NEOD", 411),
    promethium = must_element("OMNI_PT_PM", "PROM", 412),
    samarium = must_element("OMNI_PT_SM", "SAMA", 413),
    europium = must_element("OMNI_PT_EU", "EURO", 414),
    gadolinium = must_element("OMNI_PT_GD", "GADO", 415),
    terbium = must_element("OMNI_PT_TB", "TERB", 416),
    dysprosium = must_element("OMNI_PT_DY", "DYSP", 417),
    holmium = must_element("OMNI_PT_HO", "HOLM", 418),
    erbium = must_element("OMNI_PT_ER", "ERBI", 419),
    thulium = must_element("OMNI_PT_TM", "THUL", 420),
    ytterbium = must_element("OMNI_PT_YB", "YTTE", 421),
    lutetium = must_element("OMNI_PT_LU", "LUTE", 422),
    actinium = must_element("OMNI_PT_AC", "ACTN", 434),
    thorium = must_element("OMNI_PT_TH", "THOR", 435),
    protactinium = must_element("OMNI_PT_PA", "PROA", 436),
    uranium = must_element("DEFAULT_PT_URAN", "URAN", 32),
    neptunium = must_element("OMNI_PT_NP", "NEPT", 437),
    americium = must_element("OMNI_PT_AM", "AMER", 438),
    curium = must_element("OMNI_PT_CM", "CURI", 439),
    berkelium = must_element("OMNI_PT_BK", "BERK", 440),
    californium = must_element("OMNI_PT_CF", "CALF", 441),
    einsteinium = must_element("OMNI_PT_ES", "EINS", 442),
    fermium = must_element("OMNI_PT_FM", "FERM", 443),
    mendelevium = must_element("OMNI_PT_MD", "MEND", 444),
    nobelium = must_element("OMNI_PT_NO", "NOBE", 445),
    lawrencium = must_element("OMNI_PT_LR", "LAWR", 446),
    rutherfordium = must_element("OMNI_PT_RF", "RFTM", 447),
    dubnium = must_element("OMNI_PT_DB", "DUBN", 448),
    seaborgium = must_element("OMNI_PT_SG", "SEAB", 449),
    bohrium = must_element("OMNI_PT_BH", "BOHR", 450),
    hassium = must_element("OMNI_PT_HS", "HASS", 451),
    meitnerium = must_element("OMNI_PT_MT", "MEIT", 452),
    darmstadtium = must_element("OMNI_PT_DS", "DARM", 453),
    roentgenium = must_element("OMNI_PT_RG", "ROEN", 454),
    copernicium = must_element("OMNI_PT_CN", "COPE", 455),
    hafnium = must_element("OMNI_PT_HF", "HAFN", 423),
    tantalum = must_element("OMNI_PT_TA", "TANT", 424),
    tungsten = must_element("DEFAULT_PT_TUNG", "TUNG", 171),
    rhenium = must_element("OMNI_PT_RE", "RHEN", 425),
    osmium = must_element("OMNI_PT_OS", "OSMI", 426),
    iridium = must_element("OMNI_PT_IR", "IRID", 427),
