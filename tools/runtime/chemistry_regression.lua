...
local ids = {
    ...
    potassium_hydroxide = must_element("OMNI_PT_KOH", "PTOH"),
    ...
    hydrogen_sulfide = must_element("OMNI_PT_H2SG", "HSUL"),
    ammonia_water = must_element("OMNI_PT_AMWA", "AMWA"),
    barium_hydroxide = must_element("OMNI_PT_BAOH", "BAOH"),
    potassium_chloride = must_element("OMNI_PT_KCL", "PTCL"),
    ...
    calcium = must_element("OMNI_PT_CA", "CALC"),
    barium = must_element("OMNI_PT_BA", "BARI"),
    manganese = must_element("OMNI_PT_MN", "MANG"),
    sulfur = must_element("OMNI_PT_S", "SULF"),
    sodium = must_element("OMNI_PT_NA", "SODM"),
    boron = must_element("OMNI_PT_B", "BORO"),
    periodic_nitrogen = must_element("OMNI_PT_N", "NTRG"),
