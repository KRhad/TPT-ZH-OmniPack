...
local ids = {
    ...
    helium = must_element("OMNI_PT_HE", "HE"),
    nitrogen = must_element("OMNI_PT_N", "N"),
    nickel = must_element("OMNI_PT_NICL", "NICL"),
    yttrium = must_element("OMNI_PT_Y", "Y"),
    xenon = must_element("OMNI_PT_XE", "XE"),
    barium = must_element("OMNI_PT_BA", "BA"),
    radium = must_element("OMNI_PT_RA", "RA"),
    thorium = must_element("OMNI_PT_TH", "TH"),
    uranium = assert(elements.DEFAULT_PT_URAN),
    neptunium = must_element("OMNI_PT_NP", "NP"),
    curium = must_element("OMNI_PT_CM", "CM"),
    h2 = must_element("OMNI_PT_H2IS", "H-2"),
    h3 = must_element("OMNI_PT_H3IS", "H-3"),
    c14 = must_element("OMNI_PT_C14I", "C14"),
    co60 = must_element("OMNI_PT_CO60", "CO60"),
    sr90 = must_element("OMNI_PT_SR90", "SR90"),
    i131 = must_element("OMNI_PT_I131", "I131"),
    cs137 = must_element("OMNI_PT_CS37", "CS37"),
    th232 = must_element("OMNI_PT_TH32", "TH32"),
    u235 = must_element("OMNI_PT_U235", "U235"),
    u238 = must_element("OMNI_PT_U238", "U238"),
    pu239 = must_element("OMNI_PT_PU39", "PU39"),
    am241 = must_element("OMNI_PT_AM41", "AM41"),
    cf252 = must_element("OMNI_PT_CF52", "CF52"),
}
