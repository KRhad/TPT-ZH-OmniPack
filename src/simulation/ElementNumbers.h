...
DEFINE_ELEMENT(CRMC, 179)
DEFINE_ELEMENT(HEAC, 180)
DEFINE_ELEMENT(SAWD, 181)
DEFINE_ELEMENT(POLO, 182)
DEFINE_ELEMENT(RFRG, 183)
DEFINE_ELEMENT(RFGL, 184)
DEFINE_ELEMENT(LSNS, 185)
DEFINE_ELEMENT(LDTC, 186)
DEFINE_ELEMENT(SLCN, 187)
DEFINE_ELEMENT(PTNM, 188)
DEFINE_ELEMENT(VSNS, 189)
DEFINE_ELEMENT(ROCK, 190)
DEFINE_ELEMENT(LITH, 191)
DEFINE_ELEMENT(RSST, 192)
DEFINE_ELEMENT(RSSS, 193)
DEFINE_ELEMENT(BASE, 194)
DEFINE_ELEMENT(SEED, 195)
...
//OTWR
DEFINE_ELEMENT(PPTI, PT_NORMAL_NUM+3)
DEFINE_ELEMENT(PPTO, PT_NORMAL_NUM+4)
//VIRS, VRSS, VRSG, CURE
DEFINE_ELEMENT(BUTN, PT_NORMAL_NUM+5)
DEFINE_ELEMENT(PINV, PT_NORMAL_NUM+6)
DEFINE_ELEMENT(RAZR, PT_NORMAL_NUM+7)
//COND
DEFINE_ELEMENT(PWHT, PT_NORMAL_NUM+8)
DEFINE_ELEMENT(EXPL, PT_NORMAL_NUM+9)
#endif
