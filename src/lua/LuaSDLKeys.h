...
#else
	lua_pushinteger(l, SDLK_KP1); lua_setfield(l, -2, "SDLK_KP_1");
	lua_pushinteger(l, SDLK_KP2); lua_setfield(l, -2, "SDLK_KP_2");
	lua_pushinteger(l, SDLK_KP3); lua_setfield(l, -2, "SDLK_KP_3");
	lua_pushinteger(l, SDLK_KP4); lua_setfield(l, -2, "SDLK_KP_4");
	lua_pushinteger(l, SDLK_KP5); lua_setfield(l, -2, "SDLK_KP_5");
	lua_pushinteger(l, SDLK_KP6); lua_setfield(l, -2, "SDLK_KP_6");
	lua_pushinteger(l, SDLK_KP7); lua_setfield(l, -2, "SDLK_KP_7");
	lua_pushinteger(l, SDLK_KP8); lua_setfield(l, -2, "SDLK_KP_8");
	lua_pushinteger(l, SDLK_KP9); lua_setfield(l, -2, "SDLK_KP_9");
	lua_pushinteger(l, SDLK_KP0); lua_setfield(l, -2, "SDLK_KP_0");
#endif
