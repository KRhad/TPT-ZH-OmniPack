...
const std::vector<RenderPreset> Renderer::renderModePresets = {
	{
		"render.preset.alt_velocity",
		RENDER_EFFE | RENDER_BASC,
		DISPLAY_AIRC,
		0,
	},
	{
		"render.preset.velocity",
		RENDER_EFFE | RENDER_BASC,
		DISPLAY_AIRV,
		0,
	},
	{
		"render.preset.pressure",
		RENDER_EFFE | RENDER_BASC,
		DISPLAY_AIRP,
		0,
	},
	{
		"render.preset.persistent",
		RENDER_EFFE | RENDER_BASC,
		DISPLAY_PERS,
		0,
	},
	...
	{
		"render.preset.nothing",
		RENDER_BASC,
		0,
		0,
	},
	{
		"render.preset.heat_gradient",
		RENDER_BASC,
		0,
		COLOUR_GRAD,
	},
