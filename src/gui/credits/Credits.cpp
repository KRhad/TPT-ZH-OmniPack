	...
	ui::Window(ui::Point(-1, -1), ui::Point(WINDOWW, WINDOWH))
{
	...
	addHeader("Powder Toy 是一个开源项目，由社区成员开发。\n"
			"我们要感谢所有为我们的 \bt{a:https://github.com/The-Powder-Toy/The-Powder-Toy|GitHub 存储库}\x0E 做出贡献的人：", false);
	...
	addHeader("从一开始就在介绍文本中注明了以下用户。\n"
			"他们对 The Powder Toy 早期发展的贡献对于将其塑造成今天的样子来说是无价的。");
