...
{
	closeButton = new ui::Button(ui::Point(0, Size.Y-16), ui::Point(195, 16), Localization::Ref().Tr("tags.close"));
	...
	tagInput = new ui::Textbox(ui::Point(8, Size.Y-40), ui::Point(Size.X-60, 16), "", Localization::Ref().Tr("tags.new_tag_placeholder"));
	...
	addButton = new ui::Button(ui::Point(tagInput->Position.X+tagInput->Size.X+4, tagInput->Position.Y), ui::Point(40, 16), Localization::Ref().Tr("tags.add"));
	...
	title = new ui::Label(ui::Point(5, 5), ui::Point(185, 28), Localization::Ref().Tr("tags.title"));
...
void TagsView::addTag()
{
	...
	{
		new ErrorMessage(Localization::Ref().Tr("tags.error_title"), Localization::Ref().Tr("tags.error_min_length"));
		return;
	}
