	...
	totalFiles(0)
{
	...
	ui::Label * titleLabel = new ui::Label(ui::Point(4, 5), ui::Point(Size.X-8, 18), "存档浏览器");
...
{
	String deleteMessage = "确定要删除 " + files[index]->GetDisplayName() + ".cps？";
