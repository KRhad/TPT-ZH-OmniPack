...
#define BUILD_NUM 384
//VersionInfoEnd
#define FAKE_SAVE_VERSION 99
#define FAKE_MINOR_VER 3
...
#define MOD_BUILD_VERSION 171 //For update checks

#define MOBILE_MAJOR 1
#define MOBILE_MINOR 21
#define MOBILE_BUILD 128
