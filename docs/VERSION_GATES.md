...
| `GATE-020-TESTS` | 每条链的自动反应测试、OPS 往返、错误/事故/回收和压力场景通过 | 静态 Meson `15/15`、Python `100/100`；提交 `98affcd7` 绑定的 EXE `EBB33CCE...3F3D82` 的 Lua `5/5`、更新后 S04/S05/S07/S09 smoke `4/4`，但示例 OPS、正式压力样本和教程仍尚未测试 |
