...
inorganic_expansion_ids=462..477
active_element_slots=351
registered_element_slots=478
...
全部 92 个新增周期元素和 16 个无机材料完成后，当前活动元素为 `351`；`478..511` 仍有 34 个连续槽，现有冶金、生物和核工业区还分别有 9、32 和 25 个空槽。项目稳定区合计仍可再容纳 100 个活动材料，理论活动上限为 451；达到这一边界前必须优先去重和评估存档架构，不能擅自扩大 `PT_NUM` 或 `PMAPBITS`。
