...
CURRENT_PHASE=1.1.0-rc1 SDL_GPU OmniAtmosphere thermal diffusion integration
PHASE_STATUS=RC_AUTOMATED_GPU_GATE_GREEN_STABLE_MANDATORY_GATES_PENDING
BASE_COMMIT=d73b51b0f17dfaa13e8336b0d227daada97703ec
IMPLEMENTATION_HEAD=dev-1.1.0
...
V1_0_9_SOLUTION=GREEN_NACL_MASS_DISSOLUTION_EVAPORATION_CRYSTALLISATION_OPS_UNDO
V1_0_9_ACID_BASE=GREEN_HCL_NAOH_RATE_LIMITED_MASS_RESIDUAL_8_47033E_MINUS_22KG
V1_0_9_ALLOYS=GREEN_FIXED_RECIPE_COMPOSITION_5_OF_5
V1_0_9_CORROSION=GREEN_PROCESS_O2_HUMIDITY_WATER_SALT_TEMPERATURE_SURFACE_PASSIVATION_ZINC
V1_0_9_VALIDATION=GREEN_CLEAN_BUILD_864_STATIC_95_PYTHON_438_PHASE9_4_LUA_OPS_UPSTREAM
V1_0_9_BENCHMARK=RECORDED_OFF_170_112753_ON_165_114293_HASH_4264546838_OVERHEAD_2_938322_PERCENT
V1_0_9_MEMORY=40_BYTES_PER_PARTICLE_11750400_CAPACITY_BYTES
V1_0_9_REFERENCE_REFRESH=YELLOW_EXTERNAL_503_AUTH_UNAVAILABLE
V1_0_9_KNOWN_LIMITS=IRON_OXIDE_MASS_AND_STOICHIOMETRIC_O2_DEFERRED_PERFORMANCE_THRESHOLD_NOT_EVALUATED
V1_0_10_GATE=GREEN_WINDOWS_VALIDATED_CROSS_PLATFORM_CI_PENDING
V1_0_10_BACKENDS=SDL3_DESKTOP_DEFAULT_SDL2_PLATFORM_FALLBACK
...
V1_0_10_VALIDATION=GREEN_SDL3_AUTO_SDL2_BUILD_MESON_96_RUNTIME_LUA_OPS_CLIPBOARD_REGISTRATION
V1_0_10_STATIC_MINGW_SDL3=GREEN_ICONV_PRIVATE_LINK_DEPENDENCY
V1_0_10_BENCHMARK=RECORDED_OFF_121_207975_ON_132_741312_HASH_798083730_PERFORMANCE_GATE_NOT_EVALUATED
V1_0_10_GUI=WINDOW_LIVENESS_GREEN_VISUAL_INTERACTION_NOT_TESTED_COMPUTER_USE_UNAVAILABLE
V1_0_10_CROSS_PLATFORM=CI_SCRIPT_STATIC_GREEN_LINUX_MACOS_RUNTIME_PENDING_REMOTE_CI
V1_1_0_GATE=RC_ONLY_STABLE_BLOCKED_GUI_CLEAN_MACHINE_OFFICIAL_SAVE_SOAK
V1_1_0_SCOPE=SDL_GPU_VULKAN_OMNIATMOSPHERE_THERMAL_DIFFUSION_CPU_REFERENCE_FALLBACK
V1_1_0_GPU_BACKEND=VULKAN_SDL3_NVIDIA_RTX_5070_TI_LAPTOP_DRIVER_591_86
V1_1_0_GPU_DEVICE=TRUE
V1_1_0_SHADER_TOOLCHAIN=GLSLC_2026_3_SPIRV_TOOLS_2026_3_VULKAN_1_0
V1_1_0_COMPUTE_POC=TRUE_16_U32_STORAGE_WORDS_UPLOAD_DISPATCH_FENCE_READBACK
V1_1_0_DETERMINISTIC_COMPARE=TRUE_HASH_6218CE997EC92E93
V1_1_0_SDL3_PRESENTATION=GREEN_OPAQUE_00RRGGBB_BLEND_NONE_READBACK_PASS
V1_1_0_SDL2_FALLBACK=TRUE_GPU_FALSE_COMPUTE_FALSE_CPU_TRUE
V1_1_0_DEVICE_LOSS=NOT_TESTED
V1_1_0_CUDA=NOT_IMPLEMENTED_OPTIONAL_FUTURE_BACKEND_NVCC_MISSING
V1_1_0_LINUX_MACOS_RUNTIME=NOT_TESTED_WINDOWS_HOST
...
V1_1_0_PERFORMANCE_CROSSOVER=NOT_TESTED
V1_1_0_VALIDATION=GREEN_AUTO_SDL3_STATIC_SDL2_BUILD_MESON_98_OF_98
V1_1_0_STATIC_EXE_SHA256=321BAE590DB5766EED9BE375B61064DC8EAAE5C5466C5E46D5893BB44798D53B
V1_1_0_SHADER_SPIRV_SHA256=954FDABE5B207450C85167171A74679F88E6BE43FFDA2B771FE4E079CFA0A5CB
V1_1_0_DYNAMIC_SDL2_EXE_SHA256=5E5F3D617A164055A01A5546FC78E664D28A55C9E3C78EC93EFB4987C5B43C61
...
V1_0_5_GATE=GREEN
V1_0_6_GATE=GREEN
V1_0_7_GATE=GREEN_TAGGED_dev-1.0.7
V1_0_7_BASE_COMMIT=3527beb7c4c153f44bede1779a9b311705a778d1
V1_0_7_ATMOSPHERE=GREEN_FIVE_SPECIES_CONSERVATIVE_ADVECTION_DIFFUSION_PARTIAL_PRESSURE_HUMIDITY
V1_0_7_THERMAL=GREEN_STRICT_DOUBLE_WATER_ENTHALPY_SATURATION_LATENT_HEAT_PRESSURE_DEPENDENT_TRANSFER
V1_0_7_WATER_OWNERSHIP=GREEN_PARTICLE_SIDECAR_ATMOSPHERE_GAS_CONDENSED_CELL_LEDGER
V1_0_7_PERSISTENCE=GREEN_OPS_V2_WATER_SIDECAR_V1_SNAPSHOT_UNDO_REDO
V1_0_7_VALIDATION=GREEN_BUILD_STRICT_BUILD_683_STATIC_87_PYTHON_436_TOTAL_434_PASS_2_SKIP_PROBES_LUA_SAVE_UPSTREAM
V1_0_7_WATER_LONG_RUN=GREEN_1000_STEPS_DRIFT_-9_34332E_MINUS_16KG_MAX_ENERGY_RESIDUAL_0J
V1_0_7_PERFORMANCE=GREEN_ISOLATED_ENHANCED_MEDIAN_4_000402987MS_PER_TICK_AIR_BUDGET_4_1666667MS
V1_0_7_KNOWN_LIMITS=CONDENSATE_SIDEcar_NOT_VISIBLE_FOG_TRACE_SPECIES_DEFERRED_SCIENTIFIC_EQUALS_ENHANCED
...
V1_0_5_GMG=GREEN_153X96_MEDIAN_3_6188MS_DIVERGENCE_RATIO_0_00961128_306X192_AND_612X384_CONVERGED_OVER_REFERENCE_BUDGET_COMMIT_40dda20c6
V1_0_5_COUPLED_SELECTION=GREEN_VARIABLE_DENSITY_HLLC_PROJECTION_16_CROSS_ROUTE_FACES_DIVERGENCE_RATIO_0_0083031_SEALED_WALL_RATIO_0_00963955_ZERO_WALL_NORMAL_VELOCITY_COMMIT_4800f1a25
V1_0_5_SELECTION_ARTIFACT=GREEN_COMMIT_0ea5adacc_SHA256_BC9D2CDED7CBDD9CDEB0F7BD3FE79D3DA5C6E7B25BB11DA57971E0BA170CA70C_SOURCE_DIRTY_FALSE
...
V1_0_8_GATE=GREEN_READY_FOR_MILESTONE_COMMIT
V1_0_8_REACTION_RUNTIME=GREEN_STRICT_DOUBLE_CARBON_OXIDATION_V1
V1_0_8_COMBUSTION=GREEN_ENHANCED_O2_CONSUMPTION_CO2_PRODUCTION_CHEMICAL_ENERGY
V1_0_8_CLASSIC=GREEN_LEGACY_COAL_PATH_UNCHANGED
V1_0_8_CARBON_STATE=GREEN_DEDICATED_DOUBLE_SIDECAR_NO_TMP4_COLLISION
V1_0_8_PERSISTENCE=GREEN_OPS_V1_SNAPSHOT_DELTA_UNDO_REDO
V1_0_8_VALIDATION=GREEN_STRICT_LEGACY_FAST_BUILD_STATIC_90_PYTHON_436_PROBES_LUA_OPS_UPSTREAM
V1_0_8_BENCHMARK=RECORDED_OFF_114_319792_ON_90_627650_HASH_4264546838_PROFILER_SLOWDOWN_20_724445_PERCENT
KNOWN_BLOCKERS=1.1.0_cross_platform_ci visual_interaction performance_threshold iron_oxide_mass_coupling CUDA device_loss_and_production_GPU_migration
NEXT_VERSION=1.1.1
NEXT_PHASE=GPU_resource_lifetime_device_loss_and_production_migration_only_after_CPU_reference_gate
```
...
the default realism policy. The uncoupled hybrid component checkpoint now proves
advective-CFL constant-pressure transport and the whole-case HLLC Sod component,
but no router, cross-route face/reflux coupling, event-local subcycling or dynamic
acoustic halo exists. Physical time and solver selection remain unselected. See
the [policy checkpoint](../vnext/phase-5-atmosphere-policy-budget.md) and the
[hybrid component checkpoint](../vnext/phase-5-hybrid-components.md).
