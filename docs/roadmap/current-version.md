...
PHASE_STATUS=IN_PROGRESS_SHARED_CONTRACT_VALIDATED_DIRTY_SOURCE
BASE_COMMIT=13b24f49e18c22c794fae457eba9c8069fd13e6b
IMPLEMENTATION_HEAD=a21eafba301a6e02a94f81cf6da46961ec72d3cd
...
V1_0_5_SHARED_CONTRACT=GREEN_TARGETED_26_STATIC_43_PYTHON_411_TOTAL_409_PASS_2_SKIPS_DIRTY_SOURCE
...
NEXT_VERSION=1.0.6
NEXT_PHASE=add shared grid/case/result/correction-ledger contracts, then one replaceable solver candidate at a time
```
