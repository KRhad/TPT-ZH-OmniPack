...
| 工业冶金 22 + 兼容别名 1 | PASS | PASS | PASS | 历史 PASS | 可玩 ID `256..277`；`278` 只迁移旧存档 |
...
| 项目 | 状态 | 证据 |
|---|---|---|
| 18 个固定 ID、identifier 与模块映射 | PASS | `SUTR..AMCL=494..511`；当前登记门禁为 512 槽、385 个引擎活动项（含 1 别名）、384 个可玩材料、127 保留；既有 ID 未移动 |
