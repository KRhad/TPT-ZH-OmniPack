...
| 项目 | 状态 | 证据 |
|---|---|---|
| 18 个固定 ID、identifier 与模块映射 | PASS | `SUTR..AMCL=494..511`；登记门禁为 512 槽、385 活动、127 保留；既有 ID 未移动 |
| 双语名称、图鉴和材料名前缀 | PASS | i18n 为 `1582/1582` 且缺失 0；内容门禁确认 190 个 OmniPack 元素双语完整；18 个新增说明均以对应材料名开头 |
