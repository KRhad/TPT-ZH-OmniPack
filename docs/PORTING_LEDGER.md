...
| Phase 3 周期表稀有气体首批 | OmniPack `21b160a5...` 基线；候选目录只核对搜索覆盖 | OmniPack contributors | 原创族逻辑；未复制外部候选实现 | 固定 ID 370/375/379/390/405/431/461 + 共享周期引擎 | TESTING | 7 新元素、33/118 映射；行为、预算、OPS 与直接选择回归 PASS |
