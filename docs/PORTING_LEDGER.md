...
| Phase 3 周期表前五批 | OmniPack `21b160a5...`、`bcf5accf...`、`546b8791...`、`5d9b9947...`、`de91bbb6...` 基线；候选目录只核对搜索覆盖 | OmniPack contributors | 原创族逻辑；未复制外部候选实现 | 稀有气体、碱金属、碱土金属、硼族及碳族 23 个新固定 ID + 共享周期引擎 | TESTING | 23 新元素、49/118 映射；行为、预算、OPS 与直接选择回归 PASS |
