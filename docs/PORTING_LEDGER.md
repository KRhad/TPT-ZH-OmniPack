...
| Phase 3 周期表前两批 | OmniPack `21b160a5...` 与 `bcf5accf...` 基线；候选目录只核对搜索覆盖 | OmniPack contributors | 原创族逻辑；未复制外部候选实现 | 稀有气体 ID 370/375/379/390/405/431/461，碱金属 ID 376/380/406/432 + 共享周期引擎 | TESTING | 11 新元素、37/118 映射；行为、预算、OPS 与直接选择回归 PASS |
