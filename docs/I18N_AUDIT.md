...
- 生成时间（UTC）：`2026-08-09T21:55:01+00:00`
- 当前提交：`c8a0190c10afba907c1c934c42d147e46c40b240`
- 英文文件：`D:\CodexWork\OmniPack\repos\TPT-ZH-OmniPack\src\lang\en-US.json`
- 中文文件：`D:\CodexWork\OmniPack\repos\TPT-ZH-OmniPack\src\lang\zh-CN.json`
- 命令：`python tools/i18n_audit.py --write-report docs\I18N_AUDIT.md`
...
- 源码元素：488；短说明缺失（英/中）：0/0；正式名称缺失（英/中）：0/0。
- 源码菜单：18；菜单键缺失（英/中）：0/0。
- 源码字面量 `Tr()` 键：1099；缺失（英/中）：0/0。
