...
- 生成时间（UTC）：`2026-07-31T10:23:33+00:00`
- 当前提交：`f42deded7f537c343071854068c2e2c453d56cd4`
...
- 源码元素：243；短说明缺失（英/中）：0/0；正式名称缺失（英/中）：0/0。
- 源码菜单：16；菜单键缺失（英/中）：0/0。
- 源码字面量 `Tr()` 键：840；缺失（英/中）：0/0。
...
- `layout.width_risk` `alchemy.progress.button_info`：启发式显示宽度 46 超过窄 UI 阈值 32；必须以实际字体截图复核。
