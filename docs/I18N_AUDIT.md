...
- 生成时间（UTC）：`2026-08-01T04:17:47+00:00`
- 当前提交：`0eb4e11dd41fe4da72b8f8a1db65fa07a77898b1`
...
- 源码元素构造器：385，其中 1 个为隐藏兼容别名、384 个为可玩材料；短说明缺失（英/中）：0/0；正式名称缺失（英/中）：0/0。
- 源码菜单：16；菜单键缺失（英/中）：0/0。
- 源码字面量 `Tr()` 键：980；缺失（英/中）：0/0。
