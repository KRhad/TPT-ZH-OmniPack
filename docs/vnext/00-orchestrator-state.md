...
double Rusanov uniform, pressure-pulse, density-advection, contact-discontinuity and
near-vacuum, sealed Sod and smooth-grid-refinement debug probes are complete. The current phase may next
add only isolated Rusanov low-Mach or leak evidence. HLLE and LBM
steps remain out of scope until the Rusanov evidence boundary is explicitly reviewed.
