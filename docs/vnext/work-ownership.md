...
|---|---|---|---|---|---|---|---|
| Main Orchestrator | `integration/omnicore-vnext` | `D:/CodexWork/OmniPack/repos/TPT-ZH-OmniPack` | integration, review, `docs/vnext/**` | destructive Git operations, push/release | `fb72d5e8f` | integrate vNext Phase 0-1 foundations and enforce gates | ACTIVE |
