...
|---|---|---|---|---|---|---|---|
| Main Orchestrator | `integration/omnicore-vnext` | `D:/CodexWork/OmniPack/repos/TPT-ZH-OmniPack` | integration, review, `docs/vnext/**`, `docs/roadmap/**` | destructive Git operations, push/release | `fb72d5e8f` | close 1.0.1 diagnostics and start isolated 1.0.2 upstream impact audit | ACTIVE |
