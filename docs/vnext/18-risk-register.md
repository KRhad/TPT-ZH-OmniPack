...
|---|---|---|---|---|---|
| C-01 | CRITICAL | correctness/performance | direct real-acoustic mapping remains rejected at 7167 substeps/12121.47543 ms per 60 Hz tick; the 1D and 2D mixed probes close interface/global ledgers, but 32x24 reaches event fraction 0.927083, physical acoustic domain is 1434 cells, and 153x96/306x192/612x384 short-run costs are 5.56335/26.5715/106.711 ms versus 4.16667 ms budget | add near-vacuum/species routing and precision matrix; keep physical-time and solver selection RED until a policy meets domain/budget constraints | GREEN 1D/2D bounded probes, RED physical policy |
