...
public class Settings
{
	...
	static void Load( final MainActivity p )
	{
		...
		try {
			...
			// Consume the legacy value to keep the settings stream aligned, but
			// always start TPT in crisp nearest-neighbour mode.  This also fixes
			// upgrades from earlier Chinese builds which persisted smoothing=true.
			settingsFile.readBoolean();
			Globals.VideoLinearFilter = false;
